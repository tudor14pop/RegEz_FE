...
import { FolderStructure } from 'src/app/models/folder-structure.model';
...
import { UpdateFileDialogComponent } from '../common/update-file-dialog/update-file-dialog.component';
import { EditStudyFileDialogComponent } from '../common/edit-study-file-dialog/edit-study-file-dialog.component';
import { NewFolderDialogComponent } from '../common/new-folder-dialog/new-folder-dialog.component';
    ...
    actualFileID;
      constructor(private dialog: MatDialog,
       ...
       ngOnInit() {
        ...
        this.treeStructure.push({id: 1, parent: '#', text: 'Central Document Repository' , icon: 'fa fa-folder', state: {opened: true}});
