...
export const ROUTES: Routes = [
    ...
    // App views
    {
        path: 'dashboards', component: BasicLayoutComponent, canActivate: [AuthGuardService],
        children: [
    ...
    {
        path: 'dashboards', component: TopNavigationLayoutComponent, canActivate: [AuthGuardService],
        children: [
    ...
    },
    {
        ...
        children: [
            {path: 'starterview', component: StarterViewComponent, canActivate: [AuthGuardService]}
        ]
    },
    {
